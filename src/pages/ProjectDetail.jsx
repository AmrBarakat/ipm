...
const TabProjectAssistant = lazy(() => import('@/components/project-detail/TabProjectAssistant'));
...
const TAB_GROUPS = [
  ...
  { id: 'governance', label: 'GOVERNANCE', tabs: ['documents', 'notes', 'risks', 'scheduleAssistant', 'projectAssistant'] },
];
